...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(menu, authService, navCtrl, storage, alertService, loading, getService, router, http, env, camera, file, webview, actionSheetController, toastController, platform, loadingController, ref, filePath) {
        this.menu = menu;
    ...
    ProfilePage.prototype.tapUpdateAddr = function () {
        ...
        this.http.post(this.env.API_URL + 'address/modify', { address: this.address })
            .subscribe(function (data) {
            _this.customer.data.profile.addresses[0] = _this.address;
            _this.storage.set('customer', _this.customer);
        }, function (error) {
            _this.alertService.presentToast("Server not responding!");
    ...
    ProfilePage.prototype.tapUpdateContact = function () {
        ...
        this.http.post(this.env.API_URL + 'contact/modify', { contact: this.contact })
            .subscribe(function (data) {
            _this.customer.data.profile.contacts[0] = _this.contact;
            _this.storage.set('customer', _this.customer);
        }, function (error) {
            _this.alertService.presentToast("Server not responding!");
